<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="nassa-limit.aspx.cs" Inherits="WebApplication4.nassa_limit" %>
                            ...
                            <div class="panel-tag">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:TextBox ID="txtLimit" runat="server" class="form-control" />
                                    </div>
                                </div>
                            ...
                            <table style="width: 100%">
                                <tr>
                                    <td colspan="12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <asp:GridView ID="grdLimit" runat="server" class="table table-bordered table-striped"
