<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Main.Master" AutoEventWireup="true" CodeBehind="tax-tables.aspx.cs" Inherits="WebApplication4.tax_tables" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="panel-tag">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="form-label" for="drpCurrency">Currency</label>
                                      ...
                                      <div class="col-md-4">
      <label class="form-label" for="txtRate">Band Rate</label>
      <asp:TextBox ID="txtRate"  runat="server" class="form-control" />
  </div>
                                </div>
                                 <div class="form-group row">
                                  <div class="col-md-4">
                                      <label class="form-label" for="txtStartRate">From Salary</label>
                                      <asp:TextBox ID="txtStartRate"  runat="server" class="form-control" />
                                  </div>
                                  <div class="col-md-4">
                                      <label class="form-label" for="txtEndRate">To Salary</label>
                                      <asp:TextBox ID="txtEndRate" runat="server" class="form-control" />
                                  </div>
                                    <div class="col-md-4">
    <label class="form-label" for="txtCummulative">Cummulative</label>
    <asp:TextBox ID="txtCummulative" runat="server" class="form-control" />
</div>
                              </div>
   ...
   <asp:BoundField DataField="BandStart" HeaderText="BandStart"></asp:BoundField>
                                   
   <asp:BoundField DataField="BandEnd" HeaderText="BandEnd"></asp:BoundField>                                              

   <asp:BoundField DataField="BandRate" HeaderText="BandRate"></asp:BoundField>                                              
